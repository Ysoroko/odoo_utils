...
echo "Open writing on IoT Box"
sshpass -p "raspberry" ssh pi@${ip} 'sudo mount -o remount,rw /'
echo "---"
# ------
echo "Send file to IoT Box in ${1}"
echo "---"
...
echo "Sent addons/hw_posbox_homepage/controllers/main.py"
echo "---"
sshpass -p "raspberry" scp ${ODOO_ADDONS_DIR}/hw_drivers/controllers/* pi@${ip}:/home/pi/odoo/addons/hw_drivers/
echo -e "${Cyan}Sent addons/hw_drivers/*${ENDCOLOR}"
echo "---"
sshpass -p "raspberry" scp ${ODOO_ADDONS_DIR}/hw_drivers/controllers/* pi@${ip}:/home/pi/odoo/addons/hw_drivers/controllers/
echo "Sent addons/hw_drivers/controllers/*"
echo "---"
sshpass -p "raspberry" scp ${ODOO_ADDONS_DIR}/hw_drivers/tools/helpers.py pi@${ip}:/home/pi/odoo/addons/hw_drivers/tools/
echo "Sent addons/hw_drivers/tools/helpers.py"
echo "---"
...
sshpass -p "raspberry" scp ${ENTERPRISE_DIR}/iot/iot_handlers/drivers/* pi@${ip}:/home/pi/odoo/addons/hw_drivers/iot_handlers/drivers/
sshpass -p "raspberry" scp ${ODOO_ADDONS_DIR}/hw_drivers/iot_handlers/drivers/* pi@${ip}:/home/pi/odoo/addons/hw_drivers/iot_handlers/drivers/
...
echo "Sent addons/point_of_sale/tools/posbox/configuration/"
